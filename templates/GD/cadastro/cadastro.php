...
<body>
  ...
  <div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="insert01.php">
				...
				<div class="wrap-input100 validate-input" data-validate="password is required">
					...
					<input class="input100" type="password" name="confirmação de senha" placeholder="Confirme sua senha" required>
					<span class="focus-input100"></span>
				</div>
				...
				<h1><a href="../log/logar.php">Login</a></h1>
				<h1><a href="../home/index.html">Home</a></h1>
			</form>
		</div>
	</div>
